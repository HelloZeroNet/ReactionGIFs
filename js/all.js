...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/lib/00-jquery.min.js ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/lib/highlight.pack.js ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/lib/identicon.js ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/lib/jquery.cssanim.coffee ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/lib/jquery.csslater.coffee ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/lib/marked.min.js ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/lib/pnglib.js ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/utils/Class.coffee ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/utils/InlineEditor.coffee ---- */
  ...
  InlineEditor = (function() {
    ...
    InlineEditor.prototype.copyStyle = function(elem_from, elem_to) {
      ...
      elem_to.css({
        ...
        backgroundColor: from_style.backgroundColor,
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/utils/RateLimit.coffee ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/utils/Text.coffee ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/utils/Time.coffee ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/utils/ZeroFrame.coffee ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/Comments.coffee ---- */
...
/* ---- /1Gif7PqWTzVWDQ42Mo7np3zXmGAo3DXc7h/js/Gifs.coffee ---- */
...
(function() {
  ...
  ZeroBlog = (function(_super) {
    ...
    function ZeroBlog() {
      ...
      this.checkLazyVideos = __bind(this.checkLazyVideos, this);
      this.addLazyVideos = __bind(this.addLazyVideos, this);
      ...
      $.when(this.event_page_load, this.event_site_info).done((function(_this) {
        return function() {
          if (_this.site_info.settings.own || _this.data.demo) {
            ...
            $(".editbar .icon-help").on("click", function() {
          ...
          $(window).on("scroll", function() {
            return RateLimit(200, _this.checkLazyVideos);
          });
          return $(".foot").css("display", "block");
        };
      })(this));
    ...
    ZeroBlog.prototype.addLazyVideos = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push(this.lazy_videos.push([video, video.offset().top, video.innerHeight()]));
      }
      return _results;
    };

    ZeroBlog.prototype.checkLazyVideos = function() {
      var center, closest_distance, closest_video, distance, inner_h, lazy, scroll_y, video, video_height, video_top, _i, _j, _len, _len1, _ref, _ref1, _results;
      scroll_y = $(window).scrollTop();
      inner_h = window.innerHeight;
      if (scroll_y === 0) {
        center = 0;
      } else {
        center = scroll_y + inner_h / 2;
      }
      closest_video = null;
      closest_distance = 1000;
      _ref = this.lazy_videos;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        lazy = _ref[_i];
        video = lazy[0], video_top = lazy[1], video_height = lazy[2];
        distance = Math.abs(video_top + (video_height / 2) - center);
        if (distance < closest_distance) {
          closest_video = video;
          closest_distance = distance;
        }
      }
      _ref1 = this.lazy_videos;
      _results = [];
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        lazy = _ref1[_j];
        video = lazy[0];
        if (closest_video === video) {
          video[0].play();
    ...
    ZeroBlog.prototype.applyLastcommentdata = function(elem, lastcomment) {
      ...
      return elem.find(".postlink").text(lastcomment.post_title).attr("href", "?" + this.section + "&Post:" + lastcomment.post_id + ":" + title_hash);
    };
    ...
    ZeroBlog.prototype.applyPagerdata = function(page, limit, has_next) {
      ...
      pager = $(".pager");
      if (page > 1) {
        pager.find(".prev").css("display", "inline-block").attr("href", ("?" + this.section + "&page=" + (page - 1)) + (this.orderby ? "&orderby=" + this.orderby : ""));
      }
      if (has_next) {
        return pager.find(".next").css("display", "inline-block").attr("href", ("?" + this.section + "&page=" + (page + 1)) + (this.orderby ? "&orderby=" + this.orderby : ""));
      }
    };
    ...
    ZeroBlog.prototype.routeUrl = function(url) {
      ...
      $("body").addClass("page-" + this.section);
    ...
    ZeroBlog.prototype.applyPostdata = function(elem, post, full, delay) {
      ...
      $(".title .editable", elem).html(post.title).attr("href", "?" + this.section + "&Post:" + post.post_id + ":" + title_hash).data("content", post.title);
      date_published = Time.since(post.date_published);
      if (post.body.match(/^---/m)) {
        date_published += " &middot; " + (Time.readtime(post.body));
        $(".more", elem).css("display", "inline-block").attr("href", "?" + this.section + "&Post:" + post.post_id + ":" + title_hash);
      }
      $(".details .published", elem).html(date_published).data("content", post.date_published);
      if (post.comments > 0) {
        $(".details .comments-num", elem).css("display", "inline").attr("href", "?" + this.section + "&Post:" + post.post_id + ":" + title_hash);
       ...
       */
      if (post.votes > 0) {
        $(".like .num", elem).text(post.votes + " Likes");
      } else if (post.votes === -1) {
        $(".like", elem).css("display", "none");
      } else {
        $(".like .num", elem).text("Like!");
      }
    ...
    ZeroBlog.prototype.submitPostVote = function(e) {
      ...
      Page.cmd("fileGet", {
        ...
        return function(data) {
          ...
          if (elem.hasClass("active")) {
            elem.find(".num").text(current_num + 1 + " Likes");
          } else {
            elem.find(".num").text(current_num - 1 + " Likes");
          }
          return Page.writePublish(inner_path, btoa(json_raw), function(res) {
